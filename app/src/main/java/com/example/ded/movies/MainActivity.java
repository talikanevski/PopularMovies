...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Movie>> {
    ...
    private String THE_MOVIE_DB_URL = "https://api.themoviedb.org/3/movie/popular?" + API_Key_Label + API_Key;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.navigation_popular:
                THE_MOVIE_DB_URL = "https://api.themoviedb.org/3/movie/popular?" + API_Key_Label + API_Key;
                new MovieLoader(this, THE_MOVIE_DB_URL);
                reload();
                return true;
            case R.id.navigation_top_rated:
                THE_MOVIE_DB_URL = "https://api.themoviedb.org/3/movie/top_rated?" + API_Key_Label + API_Key;
                new MovieLoader(this, THE_MOVIE_DB_URL);
                reload();
                return true;
        }
